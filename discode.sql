...
INSERT INTO `post_comments` (`id`, `post_id`, `sender_id`, `content`, `parent_comment_id`, `created_at`) VALUES
(5, 15, 7, 'Great!', NULL, '2022-11-25 23:45:44'),
(6, 15, 2, 'Hihi', NULL, '2022-11-26 00:35:05');
...
ALTER TABLE `post_comments`
  ...
  ADD CONSTRAINT `post_comment_ibfk_3` FOREIGN KEY (`parent_comment_id`) REFERENCES `post_comments` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
